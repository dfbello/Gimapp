...
#       $datos['ejercicios'] = DB::select('select * from ejercicios');
...
#       
#       $rutina = DB::select('SELECT * FROM rutinas WHERE Clave_Rutina = ?',[$id]);
#       $ejercicios = DB::select('SELECT * FROM ejercicios,asignados WHERE Clave_EjercicioFK2 = Clave_Ejercicio AND Clave_RutinaFK1 = ?',[$id]);
#       
#       return view('modificarrutina', compact("rutinas","ejercicios","id"));
