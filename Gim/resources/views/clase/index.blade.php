            ...
            <tbody>
                @foreach ($clases as $key => $clase)
                    <tr>
                        ...
                        <td>
                            <form action="/Clases/{{$clase->Clave_Clase}}" method="GET">
                                @csrf
                                @method('GET')
                        ...
                        <td>
                            <a  class="btn btn-outline-primary btn-xs btn-inline" href="/Clases/{{$clase->Clave_Clase}}/edit">
                        ...
                        <td>
                            <form action="/Clases/{{$clase->Clave_Clase}}" method="POST">
                                @csrf 
                                @method('DELETE')
                                <button type="submit" class="btn btn-outline-danger btn-xs btn-inline">
