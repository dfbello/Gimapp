            ...
            <tbody>
                @foreach ($rutinas as $key => $rutina)
                    <tr>
                        ...
                        <td>
                            <a  class="btn btn-outline-primary btn-xs btn-inline" href="{{ route('modificarRutina',$rutina->Clave_Rutina)}}">
                        ...
                        <td>
                            <form action=" {{route('eliminarRutina',$rutina->Clave_Rutina)}}" method="POST">
                                @csrf @method('DELETE')
