    ...
    <div class="row justify-content-center px-5">
        <div class="col" >
            <p class="" style="font-size: 25px;">
                ...
                </svg> {{$cliente->Nombre_Entrenador}}
            </p>
            @can('entrenador.show.admin')
            <p class="" style="font-size: 25px;">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-phone" viewBox="0 0 16 16">
                  ...
                  </svg> {{$cliente->Telefono_Entrenador}}
            </p>
            <p class="" style="font-size: 25px;">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-geo-alt" viewBox="0 0 16 16">
                  ...
                  </svg> {{$cliente->Direccion_Entrenador}}
            </p>
            <p class="" style="font-size: 25px;">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16">
                    <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2Zm13 2.383-4.708 2.825L15 11.105V5.383Zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741ZM1 11.105l4.708-2.897L1 5.383v5.722Z"/>
                  </svg> {{$cliente->Correo_Entrenador }}
            </p>
        </div>
        <div class="col">
            @endcan
            <p class="" style="font-size: 25px;">
                Edad: {{$cliente->Edad_Entrenador }}
            </p>
            <p class="" style="font-size: 25px;">
                Experiencia entrenador: {{$cliente->Descripcion_Entrenador }}
            </p>
            <p class="" style="font-size: 25px;">
                Horario: {{$cliente->Horario_Entrenador  }}
            </p>
            @can('entrenador.show.cliente')
                <a class="btn btn-primary btn-sm p-2" href="/">Solicitar entrenamiento personalizado</a>
            @endcan
        </div>
    </div>
